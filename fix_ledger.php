<?php
$content = file_get_contents('c:/xampp/htdocs/qwik-gold/assets/js/modules/ledger.js');
$pattern = '/window\.viewSoldGoldDetails = async \(saleId\) => \{.*?(?=window\.togglePendingSaleSelection)/s';

$replacement = "window.viewSoldGoldDetails = async (saleId) => {
        try {
...
file_put_contents('c:/xampp/htdocs/qwik-gold/assets/js/modules/ledger.js', $new_content);
echo "done";
?>
